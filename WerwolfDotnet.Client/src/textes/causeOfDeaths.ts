...
export const causeOfDeaths: Record<CauseOfDeath, string> = {
    ...
    [CauseOfDeath.WerwolfKill]: "Durch Werwölfe getötet",
    [CauseOfDeath.WhiteWolfKill]: "Durch weißen Wolf getötet",
    ...
    [CauseOfDeath.DeathByHearthBreak]: "An Liebeskummer gestorben"
}
...
export const causeOfDeathTemplates: Record<CauseOfDeath, (players: string[]) => string> = {
    ...
    [CauseOfDeath.DeathByHearthBreak]: players => `<b>${players[0]}</b> ist an Liebeskummer gestorben.`     // Only one amor -> one amor death
}