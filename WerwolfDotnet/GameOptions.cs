...
public class GameOptions
{
    ...
    /// </summary>
    public Role[] NightExecutionOrder { get; init; } = [Role.Amor, Role.VillageMattress, Role.Healer, Role.Werwolf, Role.Urwolf, Role.Witch, Role.WhiteWolf, Role.Seer, Role.SeerApprentice];
